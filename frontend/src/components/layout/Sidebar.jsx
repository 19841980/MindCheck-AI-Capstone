 ...
 */
export default function Sidebar({ isOpen = false, onClose, notificationCount = 0, darkMode, onToggleDarkMode, onLogout }) {
  ...
  return (
    <>
      ...
      <aside className={`sidebar ${isOpen ? 'sidebar--open' : ''}`} role="navigation" aria-label="Navegación principal">
        {/* Logo */}
